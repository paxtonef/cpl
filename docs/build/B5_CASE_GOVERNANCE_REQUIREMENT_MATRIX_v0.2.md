# CPL — B5 Case Governance Requirement Matrix v0.2

**System:** Common Product Layer — CPL
**Build Unit:** B5 — Case Governance
**Artifact:** Requirement Matrix
**Version:** v0.2
**Status:** SINGLE-FINDING TRACEABILITY REPAIR — NOT ACCEPTED — NOT FROZEN
**Governance HEAD at production:** `e953605a10be8c18b9d67d28a6b74266e6916dbb`
**Source matrix (v0.1):** SHA `ed815665af88871d742019465521555f88a3257e`
**Source re-challenge (v0.1):** `docs/build/B5_CASE_GOVERNANCE_REQUIREMENT_RECHALLENGE_v0.1.md` — SHA `e953605a10be8c18b9d67d28a6b74266e6916dbb`
**Re-Challenge verdict:** `REPAIR_REQUIRED` (RM-B5-01..08 CLOSED; new finding RM-B5-09)
**Frozen WHAT:** UNCHANGED — `f53fce8f0c79aa3b5f041a964883ab8283671584`
**Implementation authorization:** NONE

---

## 0b. Repair scope [v0.2]

This revision repairs **only** `RM-B5-09` (the dangling requirement-reference identified by the Requirement Re-Challenge v0.1 inside `REQ-B5-080`, now corrected to point to `REQ-B5-109`). `RM-B5-01`→`08` remain CLOSED and are untouched. No semantic modification beyond this single reference is authorized or made.
...
**115 requirements** (108 from `v0`, of which 7 were repaired in place — `REQ-B5-047`, `051`, `052`, `055`, `080`, `081`, `082` — and 7 new requirements appended: `REQ-B5-109` → `115`). `v0.2` changes none of these counts — `RM-B5-09` repairs a single dangling reference inside `REQ-B5-080` only.
...
| RM-B5-09 | REQ-B5-080 | Fix dangling reference | REQ-B5-080 (repaired) | Requirement Re-Challenge v0.1 finding | The previously non-existent referenced identifier no longer appears anywhere; reference resolves to `REQ-B5-109` |
...
NEXT AUTHORIZED ARTIFACT:
  B5_CASE_GOVERNANCE_REQUIREMENT_RECHALLENGE_v0.2.md
```

**END — CPL B5 Case Governance Requirement Matrix v0.2**
